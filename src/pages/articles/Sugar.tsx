      ...
      <div className="w-full max-w-4xl mx-auto">
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          ...
          <section className="content-box">
            ...
            <h3 className="text-lg font-medium text-primary mt-4">חלבונים: השומרים הטובים של הסוכר</h3>
            <p className="text-gray-700 leading-relaxed">
            ...
            <h3 className="text-lg font-medium text-primary mt-4">שומנים: מאטים את קצב הספיגה</h3>
            <p className="text-gray-700 leading-relaxed">
            ...
            <h3 className="text-lg font-medium text-primary mt-4">סיבים תזונתיים: המגנים על מערכת העיכול</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="content-box overflow-x-auto">
